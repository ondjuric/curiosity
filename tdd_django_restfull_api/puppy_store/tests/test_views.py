...
from puppy_store.serializers import PuppySerializer
...
class GetAllPuppiesTest(TestCase):
    ...
    def setUp(self):
        ...
        Puppy.objects.create(
            name='Ricky', age=6, breed='Pekinezer', color='Brown'
        )
...
class DeleteSinglePuppyTest(TestCase):
    ...
    def setUp(self):
        ...
        self.muffin = Puppy.objects.create(
            name='Muffy', age=1, breed='Grandane', color='Brown'
        )
